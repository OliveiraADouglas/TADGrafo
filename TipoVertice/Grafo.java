...
//    Getters
    ...
    public ArrayList<Aresta> getAdjacente(Vertice v){ //retorna uma lista que contém todas as arestas referentes a v
        ArrayList<Aresta> adjacentes = new ArrayList(); //inicia a lista
...
//    Métodos de grafo
    public boolean isConexo(){ 
        ...
        ArrayList<Vertice> visitados = new ArrayList(); //todos os vertices que foram visitados estarão nessa lista
